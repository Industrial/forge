...
- **Same operations:** The same entity operations (list with query spec, get by id, create, update, delete) can be invoked over a second transport (e.g. WebSocket RPC), not only over REST.

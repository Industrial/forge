...
function createMockAuthStoreWithUser(user: AuthenticationUser | null) {
...
const createWrapper = (user: AuthenticationUser | null = null) => {
  ...
  const mockStoreLayer = createMockAuthStoreWithUser(user)
...
describe('ProtectedRoute component', () => {
  ...
  describe('authentication integration behavior', () => {
    test('should use useAuthStoreWithInit hook', async () => {
      const { container } = render(
        <ProtectedRoute>
          <div>Content</div>
        </ProtectedRoute>,

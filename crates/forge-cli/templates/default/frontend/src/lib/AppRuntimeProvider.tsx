...
import { httpClientWithAuthLayer, type HttpClientWithAuthConfig } from "./httpClientWithAuth";
...
export function AppRuntimeProvider({
	...
	const [runtime, setRuntime] = useState<Runtime.Runtime<HttpClient.HttpClient> | null>(null);
	...
	return <EffectRuntimeProvider runtime={runtime}>{children}</EffectRuntimeProvider>;
}

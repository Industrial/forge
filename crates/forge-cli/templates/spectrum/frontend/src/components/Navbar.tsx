...
export default function Navbar({ appName = 'React Spectrum', colorScheme = 'dark', onToggleTheme }: NavbarProps) {
  return (
    <div
      className={style({
        display: 'flex',
    ...
    >
      ...
      >
        ...
        <NavActionButton href="https://github.com/adobe/react-spectrum" aria-label="GitHub">
          <GitHubIcon />
        </NavActionButton>
